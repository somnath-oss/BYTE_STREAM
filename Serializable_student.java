...
public class Serializable_student{
    public static void main(String[] args) {
        student s1=new student(); 
        s1.roll=4;
        s1.name="Somnath";
        s1.age=21;
        String filename="student.txt"; //you can give the full path, where you want to store the file. Ex:"C:\\users\\Dektop\\student.txt" 
        ...
        try {
            ...
            objout.writeObject(s1);   //The writeObject(student) method serializes the student object and writes it to the file (student.ser).
            ...
            //you can use logging or logger instead of this. 
            //printStackTrace() is fine for debugging, but logging is better for real-world applications.
